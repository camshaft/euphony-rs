...
pub fn load(processor: u64) -> Option<BoxProcessor> {
    match processor {
        ...
        250 => Some(crate::delay::Delay::spawn()),
        251 => Some(crate::delay::Feedback::spawn()),
...
pub fn validate_parameter(processor: u64, parameter: u64, value: Value) -> Result<(), Error> {
    match processor {
        ...
        250 => crate::delay::Delay::validate_parameter(parameter, value),
        251 => crate::delay::Feedback::validate_parameter(parameter, value),
