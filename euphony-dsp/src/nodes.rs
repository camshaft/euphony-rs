...
pub fn load(processor: u64) -> Option<BoxProcessor> {
    match processor {
        ...
        65 => Some(crate::binary::Gt::spawn()),
        66 => Some(crate::binary::Gte::spawn()),
        67 => Some(crate::binary::Lt::spawn()),
        68 => Some(crate::binary::Lte::spawn()),
        69 => Some(crate::binary::Eq::spawn()),
        70 => Some(crate::binary::Ne::spawn()),
        ...
        116 => Some(crate::osc::Impulse::spawn()),
        150 => Some(crate::noise::Simplex::spawn()),
        151 => Some(crate::noise::Perlin::spawn()),
        152 => Some(crate::noise::OpenSimplex::spawn()),
        200 => Some(crate::env::Linear::spawn()),
        250 => Some(crate::delay::Bus::spawn()),
...
pub fn validate_parameter(processor: u64, parameter: u64, value: Value) -> Result<(), Error> {
    match processor {
        ...
        65 => crate::binary::Gt::validate_parameter(parameter, value),
        66 => crate::binary::Gte::validate_parameter(parameter, value),
        67 => crate::binary::Lt::validate_parameter(parameter, value),
        68 => crate::binary::Lte::validate_parameter(parameter, value),
        69 => crate::binary::Eq::validate_parameter(parameter, value),
        70 => crate::binary::Ne::validate_parameter(parameter, value),
        ...
        116 => crate::osc::Impulse::validate_parameter(parameter, value),
        150 => crate::noise::Simplex::validate_parameter(parameter, value),
        151 => crate::noise::Perlin::validate_parameter(parameter, value),
        152 => crate::noise::OpenSimplex::validate_parameter(parameter, value),
        200 => crate::env::Linear::validate_parameter(parameter, value),
        250 => crate::delay::Bus::validate_parameter(parameter, value),
